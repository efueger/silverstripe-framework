...
trait ImageManipulation {
	...
	public function updateURL(&$url) {
		...
		if(!Config::inst()->get(__CLASS__, 'force_resample') || $this->getVariant() || !$this->getIsImage()) {
			return;
		}
	...
	public function CMSThumbnail() {
		$width = Config::inst()->get(__CLASS__, 'cms_thumbnail_width');
		$height = Config::inst()->get(__CLASS__, 'cms_thumbnail_height');
	...
	public function StripThumbnail() {
		$width = Config::inst()->get(__CLASS__, 'strip_thumbnail_width');
		$height = Config::inst()->get(__CLASS__, 'strip_thumbnail_height');
		return $this->ThumbnailIcon($width, $height);
	}
	...
	public function PreviewThumbnail() {
		$width = Config::inst()->get(__CLASS__, 'asset_preview_width');
