...
class DataObjectSchema {
	...
	/**
	 * Given a column name, build the "Table"."Column" string appropriate for querying with.
	 * This method will correctly match the column to the data class and table.
	 *
	 * Note that any fixed_fields will use the base table. Use quotedID() for joining
	 * on the ID of non-base tables.
	 *
	 * @param string $class Class name
	 * @param string $column Column name
	 * @return string The quoted column, if this column belongs to this model
	 */
	...
	/**
	 * Quotes the ID column of the specific table.
	 * Unlike quotedColumn, does not force "ID" to the base table.
	 *
